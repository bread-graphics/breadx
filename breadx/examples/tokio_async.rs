...
mod inner {
    use breadx::{prelude::*, protocol::{xproto, Event}, Result, rt_support::tokio_support};
        ...
        loop {
            ...
            match event {
                Event::Expose(_) => {
                    ...
                    // draw a red "X"
                    connection.change_gc(gc, xproto::ChangeGCAux::new().foreground(red_pixel)).await?;
                    ...
                    // draw a green circle
                    connection.change_gc(gc, xproto::ChangeGCAux::new().foreground(green_pixel)).await?;
                    ...
                    connection.change_gc(gc, xproto::ChangeGCAux::new().foreground(blue_pixel)).await?;
                    connection.poly_fill_arc(
                        wid,
                        gc,
                        &[xproto::Arc {
                    ...
                    connection.change_gc(gc, xproto::ChangeGCAux::new().foreground(connection.default_screen().black_pixel)).await?;
                    connection.poly_arc(
                        wid,
                        gc,
                        &[xproto::Arc {
