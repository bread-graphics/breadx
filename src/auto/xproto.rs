...
impl<'a> AsByteSequence for Depth<'a> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 4;
        let (visuals, block_len): (Cow<'static, [Visualtype]>, usize) =
...
impl<'c, 'b> AsByteSequence for Screen<'c, 'b> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        let (allowed_depths, block_len): (Cow<'static, [Depth<'b>]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Depth<'b>>());
        Some((
...
impl EventMask {
    ...
    pub const KEY_PRESS: Self = Self { inner: 1 };
    pub const KEY_RELEASE: Self = Self { inner: 2 };
    pub const BUTTON_PRESS: Self = Self { inner: 4 };
    pub const BUTTON_RELEASE: Self = Self { inner: 8 };
    pub const ENTER_WINDOW: Self = Self { inner: 16 };
    pub const LEAVE_WINDOW: Self = Self { inner: 32 };
    pub const POINTER_MOTION: Self = Self { inner: 64 };
    pub const POINTER_MOTION_HINT: Self = Self { inner: 128 };
    pub const BUTTON1_MOTION: Self = Self { inner: 256 };
    pub const BUTTON2_MOTION: Self = Self { inner: 512 };
    pub const BUTTON3_MOTION: Self = Self { inner: 1024 };
    pub const BUTTON4_MOTION: Self = Self { inner: 2048 };
    pub const BUTTON5_MOTION: Self = Self { inner: 4096 };
    pub const BUTTON_MOTION: Self = Self { inner: 8192 };
    pub const KEYMAP_STATE: Self = Self { inner: 16384 };
    pub const EXPOSURE: Self = Self { inner: 32768 };
    pub const VISIBILITY_CHANGE: Self = Self { inner: 65536 };
    pub const STRUCTURE_NOTIFY: Self = Self { inner: 131072 };
    pub const RESIZE_REDIRECT: Self = Self { inner: 262144 };
    pub const SUBSTRUCTURE_NOTIFY: Self = Self { inner: 524288 };
    pub const SUBSTRUCTURE_REDIRECT: Self = Self { inner: 1048576 };
    pub const FOCUS_CHANGE: Self = Self { inner: 2097152 };
    pub const PROPERTY_CHANGE: Self = Self { inner: 4194304 };
    pub const COLOR_MAP_CHANGE: Self = Self { inner: 8388608 };
    pub const OWNER_GRAB_BUTTON: Self = Self { inner: 16777216 };
    pub const COMPLETE: Self = Self { inner: 33554431 };
}
...
impl<'d, 'e> AsByteSequence for SetupRequest<'d, 'e> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 2;
        let (authorization_protocol_name, block_len): (Cow<'static, str>, usize) =
            string_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, 4);
        let (authorization_protocol_data, block_len): (Cow<'static, [Card8]>, usize) =
...
impl<'f> AsByteSequence for SetupFailed<'f> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        let (reason, block_len): (Cow<'static, str>, usize) =
            string_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<c_char>());
        Some((
...
impl<'h, 'i, 'l, 'j, 'k> AsByteSequence for Setup<'h, 'i, 'l, 'j, 'k> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += block_len;
        index += buffer_pad(block_len, 4);
        let (pixmap_formats, block_len): (Cow<'static, [Format]>, usize) =
            vector_from_bytes(&bytes[index..], len2 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Format>());
        let (roots, block_len): (Cow<'static, [Screen<'j, 'k>]>, usize) =
            vector_from_bytes(&bytes[index..], len1 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Screen<'j, 'k>>());
        Some((
...
impl KeyButMask {
    ...
    pub const SHIFT: Self = Self { inner: 1 };
    pub const LOCK: Self = Self { inner: 2 };
    pub const CONTROL: Self = Self { inner: 4 };
    pub const MOD1: Self = Self { inner: 8 };
    pub const MOD2: Self = Self { inner: 16 };
    pub const MOD3: Self = Self { inner: 32 };
    pub const MOD4: Self = Self { inner: 64 };
    pub const MOD5: Self = Self { inner: 128 };
    pub const BUTTON1: Self = Self { inner: 256 };
    pub const BUTTON2: Self = Self { inner: 512 };
    pub const BUTTON3: Self = Self { inner: 1024 };
    pub const BUTTON4: Self = Self { inner: 2048 };
    pub const BUTTON5: Self = Self { inner: 4096 };
...
impl core::ops::Not for KeyButMask {
    type Output = KeyButMask;
    #[inline]
    fn not(self) -> KeyButMask {
        KeyButMask { inner: !self.inner }
    }
}
impl core::ops::BitAnd for KeyButMask {
    type Output = KeyButMask;
    #[inline]
    fn bitand(self, rhs: KeyButMask) -> KeyButMask {
        KeyButMask {
            inner: self.inner & rhs.inner,
        }
    }
}
impl core::ops::BitOr for KeyButMask {
    type Output = KeyButMask;
    #[inline]
    fn bitor(self, rhs: KeyButMask) -> KeyButMask {
        KeyButMask {
            inner: self.inner | rhs.inner,
        }
    }
}
impl core::ops::BitXor for KeyButMask {
    type Output = KeyButMask;
    #[inline]
    fn bitxor(self, rhs: KeyButMask) -> KeyButMask {
        KeyButMask {
            inner: self.inner ^ rhs.inner,
        }
    }
...
impl ConfigWindow {
    ...
    pub const X: Self = Self { inner: 1 };
    pub const Y: Self = Self { inner: 2 };
    pub const WIDTH: Self = Self { inner: 4 };
    pub const HEIGHT: Self = Self { inner: 8 };
    pub const BORDER_WIDTH: Self = Self { inner: 16 };
    pub const SIBLING: Self = Self { inner: 32 };
    pub const STACK_MODE: Self = Self { inner: 64 };
...
impl core::ops::Not for ConfigWindow {
    type Output = ConfigWindow;
    #[inline]
    fn not(self) -> ConfigWindow {
        ConfigWindow { inner: !self.inner }
    }
}
impl core::ops::BitAnd for ConfigWindow {
    type Output = ConfigWindow;
    #[inline]
    fn bitand(self, rhs: ConfigWindow) -> ConfigWindow {
        ConfigWindow {
            inner: self.inner & rhs.inner,
        }
    }
}
impl core::ops::BitOr for ConfigWindow {
    type Output = ConfigWindow;
    #[inline]
    fn bitor(self, rhs: ConfigWindow) -> ConfigWindow {
        ConfigWindow {
            inner: self.inner | rhs.inner,
        }
    }
}
impl core::ops::BitXor for ConfigWindow {
    type Output = ConfigWindow;
    #[inline]
    fn bitxor(self, rhs: ConfigWindow) -> ConfigWindow {
        ConfigWindow {
            inner: self.inner ^ rhs.inner,
        }
    }
...
impl Cw {
    ...
    pub const BACK_PIXMAP: Self = Self { inner: 1 };
    pub const BACK_PIXEL: Self = Self { inner: 2 };
    pub const BORDER_PIXMAP: Self = Self { inner: 4 };
    pub const BORDER_PIXEL: Self = Self { inner: 8 };
    pub const BIT_GRAVITY: Self = Self { inner: 16 };
    pub const WIN_GRAVITY: Self = Self { inner: 32 };
    pub const BACKING_STORE: Self = Self { inner: 64 };
    pub const BACKING_PLANES: Self = Self { inner: 128 };
    pub const BACKING_PIXEL: Self = Self { inner: 256 };
    pub const OVERRIDE_REDIRECT: Self = Self { inner: 512 };
    pub const SAVE_UNDER: Self = Self { inner: 1024 };
    pub const EVENT_MASK: Self = Self { inner: 2048 };
    pub const DONT_PROPAGATE: Self = Self { inner: 4096 };
    pub const COLORMAP: Self = Self { inner: 8192 };
    pub const CURSOR: Self = Self { inner: 16384 };
    pub const COMPLETE: Self = Self { inner: 32767 };
}
...
impl core::ops::BitAnd for Cw {
    type Output = Cw;
    #[inline]
    fn bitand(self, rhs: Cw) -> Cw {
        Cw {
            inner: self.inner & rhs.inner,
        }
    }
}
impl core::ops::BitOr for Cw {
    type Output = Cw;
    #[inline]
    fn bitor(self, rhs: Cw) -> Cw {
        Cw {
            inner: self.inner | rhs.inner,
        }
    }
}
impl core::ops::BitXor for Cw {
    type Output = Cw;
    #[inline]
    fn bitxor(self, rhs: Cw) -> Cw {
        Cw {
            inner: self.inner ^ rhs.inner,
        }
    }
...
impl<'m> AsByteSequence for QueryTreeReply<'m> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 14;
        let (children, block_len): (Cow<'static, [Window]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Window>());
        Some((
...
impl<'p> AsByteSequence for ChangePropertyRequest<'p> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        let (data, block_len): (Cow<'static, [Void]>, usize) = vector_from_bytes(
            &bytes[index..],
...
impl<'q> AsByteSequence for GetPropertyReply<'q> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 12;
        let (value, block_len): (Cow<'static, [Void]>, usize) = vector_from_bytes(
            &bytes[index..],
...
impl ModMask {
    ...
    pub const LOCK: Self = Self { inner: 2 };
    pub const CONTROL: Self = Self { inner: 4 };
    pub const ONE: Self = Self { inner: 8 };
    pub const TWO: Self = Self { inner: 16 };
    pub const THREE: Self = Self { inner: 32 };
    pub const FOUR: Self = Self { inner: 64 };
    pub const FIVE: Self = Self { inner: 128 };
    pub const ANY: Self = Self { inner: 32768 };
    pub const COMPLETE: Self = Self { inner: 33023 };
}
...
impl core::ops::Not for ModMask {
    type Output = ModMask;
    #[inline]
    fn not(self) -> ModMask {
        ModMask { inner: !self.inner }
    }
}
impl core::ops::BitAnd for ModMask {
    type Output = ModMask;
    #[inline]
...
impl core::ops::BitOr for ModMask {
    type Output = ModMask;
    #[inline]
...
impl core::ops::BitXor for ModMask {
    type Output = ModMask;
    #[inline]
    fn bitxor(self, rhs: ModMask) -> ModMask {
        ModMask {
            inner: self.inner ^ rhs.inner,
        }
    }
...
impl<'s> AsByteSequence for GetMotionEventsReply<'s> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 20;
        let (events, block_len): (Cow<'static, [Timecoord]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Timecoord>());
        Some((
...
impl<'u, 'v> AsByteSequence for QueryFontReply<'u, 'v> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        let (properties, block_len): (Cow<'static, [Fontprop]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Fontprop>());
        let (char_infos, block_len): (Cow<'static, [Charinfo]>, usize) =
            vector_from_bytes(&bytes[index..], len1 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Charinfo>());
        Some((
...
impl<'w> QueryTextExtentsRequest {}
impl<'w> AsByteSequence for QueryTextExtentsRequest<'w> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (length, sz): (u16, usize) = <u16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (string, block_len): (Cow<'static, [Char2b]>, usize) =
...
#[derive(Clone, Debug, Default, PartialEq, PartialOrd)]
pub struct ListFontsRequest<'ab> {
    pub req_type: u8,
    pub length: u16,
    pub max_names: Card16,
    pub pattern: Cow<'ab, str>,
}
impl<'ab> ListFontsRequest {}
impl<'ab> AsByteSequence for ListFontsRequest<'ab> {
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index: usize = 0;
        index += self.req_type.as_bytes(&mut bytes[index..]);
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (len0, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (pattern, block_len): (Cow<'static, str>, usize) =
            string_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<c_char>());
        Some((
...
#[derive(Clone, Debug, Default, PartialEq, PartialOrd)]
pub struct ListFontsReply<'z, 'y> {
    pub reply_type: u8,
    pub sequence: u16,
    pub length: u32,
    pub names: Cow<'z, [Str<'y>]>,
}
impl<'z, 'y> ListFontsReply {}
impl<'z, 'y> AsByteSequence for ListFontsReply<'z, 'y> {
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index: usize = 0;
        index += self.reply_type.as_bytes(&mut bytes[index..]);
        ...
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Str<'y>>());
        index
    }
    #[inline]
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 22;
        let (names, block_len): (Cow<'static, [Str<'y>]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Str<'y>>());
        Some((
    ...
    fn size(&self) -> usize {
        self.reply_type.size()
            ...
            + {
                ...
                let pad: usize = buffer_pad(block_len, ::core::mem::align_of::<Str<'y>>());
                block_len + pad
            }
    }
}
#[derive(Clone, Debug, Default, PartialEq, PartialOrd)]
pub struct ListFontsWithInfoRequest<'db> {
    pub req_type: u8,
    pub length: u16,
    pub max_names: Card16,
    pub pattern: Cow<'db, str>,
}
impl<'db> ListFontsWithInfoRequest {}
impl<'db> AsByteSequence for ListFontsWithInfoRequest<'db> {
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index: usize = 0;
        index += self.req_type.as_bytes(&mut bytes[index..]);
...
#[derive(Clone, Debug, Default, PartialEq, PartialOrd)]
pub struct ListFontsWithInfoReply<'bb, 'cb> {
    pub reply_type: u8,
    pub sequence: u16,
    pub length: u32,
    pub min_bounds: Charinfo,
    ...
    pub properties: Cow<'bb, [Fontprop]>,
    pub name: Cow<'cb, str>,
}
impl<'bb, 'cb> ListFontsWithInfoReply {}
impl<'bb, 'cb> AsByteSequence for ListFontsWithInfoReply<'bb, 'cb> {
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index: usize = 0;
        index += self.reply_type.as_bytes(&mut bytes[index..]);
...
impl<'fb, 'eb> AsByteSequence for SetFontPathRequest<'fb, 'eb> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 2;
        let (font, block_len): (Cow<'static, [Str<'eb>]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Str<'eb>>());
        Some((
...
impl<'hb, 'gb> AsByteSequence for GetFontPathReply<'hb, 'gb> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 22;
        let (path, block_len): (Cow<'static, [Str<'gb>]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Str<'gb>>());
        Some((
...
impl Gc {
    ...
    pub const FUNCTION: Self = Self { inner: 1 };
    pub const PLANE_MASK: Self = Self { inner: 2 };
    pub const FOREGROUND: Self = Self { inner: 4 };
    pub const BACKGROUND: Self = Self { inner: 8 };
    pub const LINE_WIDTH: Self = Self { inner: 16 };
    pub const LINE_STYLE: Self = Self { inner: 32 };
    pub const CAP_STYLE: Self = Self { inner: 64 };
    pub const JOIN_STYLE: Self = Self { inner: 128 };
    pub const FILL_STYLE: Self = Self { inner: 256 };
    pub const FILL_RULE: Self = Self { inner: 512 };
    pub const TILE: Self = Self { inner: 1024 };
    pub const STIPPLE: Self = Self { inner: 2048 };
    pub const TILE_STIPPLE_ORIGIN_X: Self = Self { inner: 4096 };
    pub const TILE_STIPPLE_ORIGIN_Y: Self = Self { inner: 8192 };
    pub const FONT: Self = Self { inner: 16384 };
    pub const SUBWINDOW_MODE: Self = Self { inner: 32768 };
    pub const GRAPHICS_EXPOSURES: Self = Self { inner: 65536 };
    pub const CLIP_ORIGIN_X: Self = Self { inner: 131072 };
    pub const CLIP_ORIGIN_Y: Self = Self { inner: 262144 };
    pub const CLIP_MASK: Self = Self { inner: 524288 };
    pub const DASH_OFFSET: Self = Self { inner: 1048576 };
    pub const DASH_LIST: Self = Self { inner: 2097152 };
    pub const ARC_MODE: Self = Self { inner: 4194304 };
    pub const COMPLETE: Self = Self { inner: 8388607 };
}
...
impl<'ib> AsByteSequence for SetDashesRequest<'ib> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (len0, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (dashes, block_len): (Cow<'static, [Card8]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Card8>());
        Some((
...
impl<'jb> SetClipRectanglesRequest {}
...
impl<'mb> AsByteSequence for PolySegmentRequest<'mb> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
        index += sz;
        let (segments, block_len): (Cow<'static, [Segment]>, usize) =
            vector_from_bytes(&bytes[index..], ((length as usize * 4) - index) as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Segment>());
        Some((
...
impl<'ob> AsByteSequence for PolyArcRequest<'ob> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
        index += sz;
        let (arcs, block_len): (Cow<'static, [Arc]>, usize) =
            vector_from_bytes(&bytes[index..], ((length as usize * 4) - index) as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Arc>());
        Some((
...
impl<'qb> PolyFillRectangleRequest {}
...
impl<'ub> AsByteSequence for PolyText8Request<'ub> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (y, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (items, block_len): (Cow<'static, [Byte]>, usize) =
            vector_from_bytes(&bytes[index..], ((length as usize * 4) - index) as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Byte>());
        Some((
...
impl<'yb> ListInstalledColormapsReply {}
impl<'yb> AsByteSequence for ListInstalledColormapsReply<'yb> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 22;
        let (cmaps, block_len): (Cow<'static, [Colormap]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Colormap>());
        Some((
...
impl<'zb> AllocNamedColorRequest {}
...
impl<'ac, 'bc> AllocColorCellsReply {}
impl<'ac, 'bc> AsByteSequence for AllocColorCellsReply<'ac, 'bc> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 20;
        let (pixels, block_len): (Cow<'static, [Card32]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Card32>());
        let (masks, block_len): (Cow<'static, [Card32]>, usize) =
            vector_from_bytes(&bytes[index..], len1 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Card32>());
        Some((
...
impl ColorFlag {
    ...
    pub const RED: Self = Self { inner: 1 };
    pub const GREEN: Self = Self { inner: 2 };
    pub const BLUE: Self = Self { inner: 4 };
...
impl core::ops::Not for ColorFlag {
    type Output = ColorFlag;
    #[inline]
    fn not(self) -> ColorFlag {
        ColorFlag { inner: !self.inner }
    }
}
impl core::ops::BitAnd for ColorFlag {
    type Output = ColorFlag;
    #[inline]
    fn bitand(self, rhs: ColorFlag) -> ColorFlag {
        ColorFlag {
            inner: self.inner & rhs.inner,
        }
    }
}
impl core::ops::BitOr for ColorFlag {
    type Output = ColorFlag;
    #[inline]
    fn bitor(self, rhs: ColorFlag) -> ColorFlag {
        ColorFlag {
            inner: self.inner | rhs.inner,
        }
    }
}
impl core::ops::BitXor for ColorFlag {
    type Output = ColorFlag;
    #[inline]
    fn bitxor(self, rhs: ColorFlag) -> ColorFlag {
        ColorFlag {
            inner: self.inner ^ rhs.inner,
        }
    }
...
impl<'ec> AsByteSequence for StoreColorsRequest<'ec> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        let (items, block_len): (Cow<'static, [Coloritem]>, usize) =
            vector_from_bytes(&bytes[index..], ((length as usize * 4) - index) as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Coloritem>());
        Some((
...
impl<'fc> StoreNamedColorRequest {}
...
#[derive(Clone, Debug, Default, PartialEq, PartialOrd)]
pub struct QueryColorsRequest<'hc> {
    pub req_type: u8,
    pub length: u16,
    pub cmap: Colormap,
    pub pixels: Cow<'hc, [Card32]>,
}
impl<'hc> QueryColorsRequest {}
impl<'hc> AsByteSequence for QueryColorsRequest<'hc> {
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index: usize = 0;
        index += self.req_type.as_bytes(&mut bytes[index..]);
...
#[derive(Clone, Debug, Default, PartialEq, PartialOrd)]
pub struct QueryColorsReply<'gc> {
    pub reply_type: u8,
    pub sequence: u16,
    pub length: u32,
    pub colors: Cow<'gc, [Rgb]>,
}
impl<'gc> QueryColorsReply {}
impl<'gc> AsByteSequence for QueryColorsReply<'gc> {
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index: usize = 0;
        index += self.reply_type.as_bytes(&mut bytes[index..]);
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 22;
        let (colors, block_len): (Cow<'static, [Rgb]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Rgb>());
        Some((
...
impl<'lc, 'kc> ListExtensionsReply {}
impl<'lc, 'kc> AsByteSequence for ListExtensionsReply<'lc, 'kc> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 24;
        let (names, block_len): (Cow<'static, [Str<'kc>]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Str<'kc>>());
        Some((
...
impl<'mc> ChangeKeyboardMappingRequest {}
...
impl<'nc> GetKeyboardMappingReply {}
...
impl Kb {
    ...
    pub const BELL_PERCENT: Self = Self { inner: 2 };
    pub const BELL_PITCH: Self = Self { inner: 4 };
    pub const BELL_DURATION: Self = Self { inner: 8 };
...
impl core::ops::BitAnd for Kb {
    type Output = Kb;
    #[inline]
    fn bitand(self, rhs: Kb) -> Kb {
        Kb {
            inner: self.inner & rhs.inner,
        }
    }
}
impl core::ops::BitOr for Kb {
    type Output = Kb;
    #[inline]
    fn bitor(self, rhs: Kb) -> Kb {
        Kb {
            inner: self.inner | rhs.inner,
        }
    }
}
impl core::ops::BitXor for Kb {
    type Output = Kb;
    #[inline]
    fn bitxor(self, rhs: Kb) -> Kb {
        Kb {
            inner: self.inner ^ rhs.inner,
        }
    }
...
impl<'oc> AsByteSequence for ChangeHostsRequest<'oc> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (len0, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (address, block_len): (Cow<'static, [Byte]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Byte>());
        Some((
...
impl<'rc, 'qc> AsByteSequence for ListHostsReply<'rc, 'qc> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        index += sz;
        index += 22;
        let (hosts, block_len): (Cow<'static, [Host<'qc>]>, usize) =
            vector_from_bytes(&bytes[index..], len0 as usize)?;
        index += block_len;
        index += buffer_pad(block_len, ::core::mem::align_of::<Host<'qc>>());
        Some((
...
impl<'sc> RotatePropertiesRequest {}
...
impl<'tc> SetPointerMappingRequest {}
...
impl<'uc> GetPointerMappingReply {}
...
impl<'vc> SetModifierMappingRequest {}
impl<'vc> AsByteSequence for SetModifierMappingRequest<'vc> {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        ...
        let (length, sz): (u16, usize) = <u16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (keycodes, block_len): (Cow<'static, [Keycode]>, usize) = vector_from_bytes(
            &bytes[index..],
...
impl<'wc> GetModifierMappingReply {}
...
impl ButtonMask {
    ...
    pub const ONE: Self = Self { inner: 256 };
    pub const TWO: Self = Self { inner: 512 };
    pub const THREE: Self = Self { inner: 1024 };
    pub const FOUR: Self = Self { inner: 2048 };
    pub const FIVE: Self = Self { inner: 4096 };
    pub const ANY: Self = Self { inner: 32768 };
    pub const COMPLETE: Self = Self { inner: 40704 };
}
...
impl core::ops::Not for ButtonMask {
    type Output = ButtonMask;
    #[inline]
    fn not(self) -> ButtonMask {
        ButtonMask { inner: !self.inner }
    }
}
...
impl core::ops::BitXor for ButtonMask {
    type Output = ButtonMask;
    #[inline]
    fn bitxor(self, rhs: ButtonMask) -> ButtonMask {
        ButtonMask {
            inner: self.inner ^ rhs.inner,
        }
    }
...
impl AsByteSequence for KeymapNotifyEvent {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.event_type.size() + self.keys.size()
    }
}
