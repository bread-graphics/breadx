// This file was automatically generated by the flutterbug_generator crate from "/home/jtnunley/Programming/Projects/flutterbug/xml/xproto.xml".
...
impl AsByteSequence for Char2b {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Char2b from bytes");
...
impl AsByteSequence for Point {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Point from bytes");
...
impl AsByteSequence for Rectangle {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Rectangle from bytes");
        let (x, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (y, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for Arc {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Arc from bytes");
        let (x, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (y, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for Format {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Format from bytes");
...
impl AsByteSequence for Visualtype {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Visualtype from bytes");
...
impl AsByteSequence for Depth {
    #[inline]
    fn size() -> usize {
        <Visualtype>::size() * 32 + 4 + 4 + 1 + <Card8>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Depth from bytes");
        let (depth, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len1784564322, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 4;
        let (visuals, sz): (Vec<Visualtype>, usize) =
            vector_from_bytes(bytes, len1784564322 as usize)?;
        index += sz;
...
impl AsByteSequence for Screen {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Screen from bytes");
        ...
        index += sz;
        let (save_unders, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (root_depth, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len1663993774, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (allowed_depths, sz): (Vec<Depth>, usize) =
            vector_from_bytes(bytes, len1663993774 as usize)?;
        index += sz;
        Some((
            Self {
                root,
...
impl AsByteSequence for SetupRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetupRequest from bytes");
        ...
        index += sz;
        let (len1553615646, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len797601294, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (authorization_protocol_name, sz): (String, usize) =
            string_from_bytes(bytes, len1553615646 as usize)?;
        index += sz;
        let (authorization_protocol_data, sz): (String, usize) =
            string_from_bytes(bytes, len797601294 as usize)?;
        index += sz;
        Some((
            Self {
                byte_order,
...
impl AsByteSequence for SetupFailed {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetupFailed from bytes");
        let (status, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len288204267, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (protocol_major_version, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (protocol_minor_version, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        ...
        index += sz;
        let (reason, sz): (String, usize) = string_from_bytes(bytes, len288204267 as usize)?;
        index += sz;
        Some((
            Self {
                status,
...
impl AsByteSequence for SetupAuthenticate {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetupAuthenticate from bytes");
        let (status, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 5;
        let (length, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        ...
        let (reason, sz): (String, usize) =
            string_from_bytes(bytes, (length as usize * 4) as usize)?;
        index += sz;
        Some((
            Self {
                status,
...
impl AsByteSequence for Setup {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Setup from bytes");
        let (status, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (protocol_major_version, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        ...
        index += sz;
        let (len2531182004, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (maximum_request_length, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len2981289250, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len1561909856, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        index += sz;
        index += 4;
        let (vendor, sz): (String, usize) = string_from_bytes(bytes, len2531182004 as usize)?;
        index += sz;
        let (pixmap_formats, sz): (Vec<Format>, usize) =
            vector_from_bytes(bytes, len1561909856 as usize)?;
        index += sz;
        let (roots, sz): (Vec<Screen>, usize) = vector_from_bytes(bytes, len2981289250 as usize)?;
        index += sz;
        Some((
            Self {
                status,
...
impl AsByteSequence for CreateWindowRequest {
    ...
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        ...
        index += vector_as_bytes(&self.value_list, &mut bytes[index..]);
        index
    }
    #[inline]
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CreateWindowRequest from bytes");
        let (depth, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        index += sz;
        let (value_list, sz): (Vec<u32>, usize) =
            vector_from_bytes(bytes, value_mask.count_ones() as usize)?;
        index += sz;
        Some((
            Self {
                depth,
...
impl AsByteSequence for ChangeWindowAttributesRequest {
    #[inline]
    fn size() -> usize {
        <u32>::size() * 32 + <Card32>::size() + <Window>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangeWindowAttributesRequest from bytes");
        index += 1;
...
impl AsByteSequence for GetWindowAttributesRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetWindowAttributesRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
pub struct GetWindowAttributesReply {
    ...
    pub save_under: cty::c_char,
    pub map_is_installed: cty::c_char,
    pub map_state: Card8,
    pub override_redirect: cty::c_char,
...
impl AsByteSequence for GetWindowAttributesReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetWindowAttributesReply from bytes");
        ...
        index += sz;
        let (save_under, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (map_is_installed, sz): (cty::c_char, usize) =
            <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (map_state, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (override_redirect, sz): (cty::c_char, usize) =
            <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for DestroyWindowRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing DestroyWindowRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for DestroySubwindowsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing DestroySubwindowsRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for ChangeSaveSetRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangeSaveSetRequest from bytes");
...
impl AsByteSequence for ReparentWindowRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ReparentWindowRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (parent, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for MapWindowRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing MapWindowRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for MapSubwindowsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing MapSubwindowsRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for UnmapWindowRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UnmapWindowRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for UnmapSubwindowsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UnmapSubwindowsRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for ConfigureWindowRequest {
    #[inline]
    fn size() -> usize {
        <u32>::size() * 32 + <Card16>::size() + 2 + <Window>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ConfigureWindowRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
...
impl AsByteSequence for CirculateWindowRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CirculateWindowRequest from bytes");
...
impl AsByteSequence for GetGeometryRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetGeometryRequest from bytes");
        index += 1;
...
impl AsByteSequence for GetGeometryReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetGeometryReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for QueryTreeRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryTreeRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for QueryTreeReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryTreeReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        let (parent, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len2124937039, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 14;
        let (children, sz): (Vec<Window>, usize) =
            vector_from_bytes(bytes, len2124937039 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
pub struct InternAtomRequest {
    pub only_if_exists: cty::c_char,
    pub name: String,
}
impl AsByteSequence for InternAtomRequest {
    #[inline]
    fn size() -> usize {
        <u8>::size() * 32 + 2 + 4 + <cty::c_char>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing InternAtomRequest from bytes");
        let (only_if_exists, sz): (cty::c_char, usize) =
            <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len2698056085, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len2698056085 as usize)?;
        index += sz;
        Some((
            Self {
                only_if_exists,
...
impl AsByteSequence for InternAtomReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing InternAtomReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetAtomNameRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetAtomNameRequest from bytes");
        index += 1;
        let (atom, sz): (Atom, usize) = <Atom>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetAtomNameReply {
    #[inline]
    fn size() -> usize {
        <u8>::size() * 32 + 22 + 4 + 1 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetAtomNameReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len3439865613, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 22;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len3439865613 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for ChangePropertyRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangePropertyRequest from bytes");
        ...
        let (data, sz): (Vec<u8>, usize) = vector_from_bytes(
            bytes,
            ((data_len as usize * format as usize) / format as usize) as usize,
        )?;
        index += sz;
        Some((
            Self {
...
impl AsByteSequence for DeletePropertyRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing DeletePropertyRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (property, sz): (Atom, usize) = <Atom>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for GetPropertyRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetPropertyRequest from bytes");
        let (delete, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (property, sz): (Atom, usize) = <Atom>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for GetPropertyReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetPropertyReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        let (value, sz): (Vec<u8>, usize) =
            vector_from_bytes(bytes, (value_len as usize * (format as usize / 8)) as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for ListPropertiesRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListPropertiesRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for ListPropertiesReply {
    #[inline]
    fn size() -> usize {
        <Atom>::size() * 32 + 22 + 4 + 1 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListPropertiesReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len2213955960, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 22;
        let (atoms, sz): (Vec<Atom>, usize) = vector_from_bytes(bytes, len2213955960 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for SetSelectionOwnerRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetSelectionOwnerRequest from bytes");
        index += 1;
...
impl AsByteSequence for GetSelectionOwnerRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetSelectionOwnerRequest from bytes");
        index += 1;
        let (selection, sz): (Atom, usize) = <Atom>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetSelectionOwnerReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetSelectionOwnerReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for ConvertSelectionRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ConvertSelectionRequest from bytes");
        index += 1;
...
impl AsByteSequence for SendEventRequest {
    #[inline]
    fn size() -> usize {
        <[bool; 32]>::size() + <Card32>::size() + <Window>::size() + <cty::c_char>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SendEventRequest from bytes");
        let (propagate, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GrabPointerRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GrabPointerRequest from bytes");
        let (owner_events, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GrabPointerReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GrabPointerReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for UngrabPointerRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UngrabPointerRequest from bytes");
        index += 1;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GrabButtonRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GrabButtonRequest from bytes");
        let (owner_events, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (grab_window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for UngrabButtonRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UngrabButtonRequest from bytes");
        let (button, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (grab_window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for ChangeActivePointerGrabRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangeActivePointerGrabRequest from bytes");
        index += 1;
        let (cursor, sz): (Cursor, usize) = <Cursor>::from_bytes(&bytes[index..])?;
        index += sz;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for GrabKeyboardRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GrabKeyboardRequest from bytes");
        let (owner_events, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (grab_window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GrabKeyboardReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GrabKeyboardReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for UngrabKeyboardRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UngrabKeyboardRequest from bytes");
        index += 1;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { time }, index))
...
impl AsByteSequence for GrabKeyRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GrabKeyRequest from bytes");
        let (owner_events, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (grab_window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for UngrabKeyRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UngrabKeyRequest from bytes");
        let (key, sz): (Keycode, usize) = <Keycode>::from_bytes(&bytes[index..])?;
        index += sz;
        let (grab_window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for AllowEventsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllowEventsRequest from bytes");
        let (mode, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for QueryPointerRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryPointerRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for QueryPointerReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryPointerReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (same_screen, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (root, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for Timecoord {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Timecoord from bytes");
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
        let (x, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetMotionEventsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetMotionEventsRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetMotionEventsReply {
    #[inline]
    fn size() -> usize {
        <Timecoord>::size() * 32 + 20 + 4 + 1 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetMotionEventsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len2640169631, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 20;
        let (events, sz): (Vec<Timecoord>, usize) =
            vector_from_bytes(bytes, len2640169631 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for TranslateCoordinatesRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing TranslateCoordinatesRequest from bytes");
        index += 1;
...
impl AsByteSequence for TranslateCoordinatesReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing TranslateCoordinatesReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for WarpPointerRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing WarpPointerRequest from bytes");
        index += 1;
        let (src_window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (dst_window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for SetInputFocusRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetInputFocusRequest from bytes");
...
impl AsByteSequence for GetInputFocusReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetInputFocusReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for QueryKeymapReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryKeymapReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for OpenFontRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing OpenFontRequest from bytes");
        index += 1;
        let (fid, sz): (Font, usize) = <Font>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len571280600, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len571280600 as usize)?;
        index += sz;
...
impl AsByteSequence for CloseFontRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CloseFontRequest from bytes");
        index += 1;
...
impl AsByteSequence for Fontprop {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Fontprop from bytes");
...
impl AsByteSequence for Charinfo {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Charinfo from bytes");
...
impl AsByteSequence for QueryFontRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryFontRequest from bytes");
        index += 1;
...
pub struct QueryFontReply {
    ...
    pub all_chars_exist: cty::c_char,
...
impl AsByteSequence for QueryFontReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryFontReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        index += sz;
        let (len526634672, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        index += sz;
        let (all_chars_exist, sz): (cty::c_char, usize) =
            <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        index += sz;
        let (len253729083, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (properties, sz): (Vec<Fontprop>, usize) =
            vector_from_bytes(bytes, len526634672 as usize)?;
        index += sz;
        let (char_infos, sz): (Vec<Charinfo>, usize) =
            vector_from_bytes(bytes, len253729083 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for QueryTextExtentsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryTextExtentsRequest from bytes");
        let (font, sz): (Fontable, usize) = <Fontable>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { font }, index))
    }
...
impl AsByteSequence for QueryTextExtentsReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryTextExtentsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for ListFontsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListFontsRequest from bytes");
        index += 1;
        let (max_names, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len4064758066, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (pattern, sz): (String, usize) = string_from_bytes(bytes, len4064758066 as usize)?;
        index += sz;
...
impl AsByteSequence for ListFontsReply {
    #[inline]
    fn size() -> usize {
        <String>::size() * 32 + 22 + 4 + 1 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListFontsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len2796749440, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 22;
        let (names, sz): (Vec<String>, usize) = vector_from_bytes(bytes, len2796749440 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for ListFontsWithInfoRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListFontsWithInfoRequest from bytes");
        index += 1;
        let (max_names, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len1416332923, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (pattern, sz): (String, usize) = string_from_bytes(bytes, len1416332923 as usize)?;
        index += sz;
        Some((Self { max_names, pattern }, index))
    }
    #[inline]
...
impl AsByteSequence for ListFontsWithInfoReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListFontsWithInfoReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len2703764166, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (min_bounds, sz): (Charinfo, usize) = <Charinfo>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 4;
        ...
        let (default_char, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len1343096961, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (draw_direction, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        let (min_byteOne, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        ...
        index += sz;
        let (properties, sz): (Vec<Fontprop>, usize) =
            vector_from_bytes(bytes, len1343096961 as usize)?;
        index += sz;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len2703764166 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for SetFontPathRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetFontPathRequest from bytes");
        index += 1;
        let (len1184214378, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (font, sz): (Vec<String>, usize) = vector_from_bytes(bytes, len1184214378 as usize)?;
        index += sz;
        Some((Self { font }, index))
    }
    #[inline]
...
impl AsByteSequence for GetFontPathReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetFontPathReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len821424070, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 22;
        let (path, sz): (Vec<String>, usize) = vector_from_bytes(bytes, len821424070 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for CreatePixmapRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CreatePixmapRequest from bytes");
        let (depth, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for FreePixmapRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing FreePixmapRequest from bytes");
        index += 1;
...
impl AsByteSequence for CreateGCRequest {
    #[inline]
    fn size() -> usize {
        <u32>::size() * 32 + <Card32>::size() + <Drawable>::size() + <Gcontext>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CreateGCRequest from bytes");
        index += 1;
...
impl AsByteSequence for ChangeGCRequest {
    #[inline]
    fn size() -> usize {
        <u32>::size() * 32 + <Card32>::size() + <Gcontext>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangeGCRequest from bytes");
        index += 1;
...
impl AsByteSequence for CopyGCRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CopyGCRequest from bytes");
        index += 1;
...
impl AsByteSequence for SetDashesRequest {
    #[inline]
    fn size() -> usize {
        <Card8>::size() * 32 + 4 + <Card16>::size() + <Gcontext>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetDashesRequest from bytes");
        index += 1;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
        index += sz;
        let (dash_offset, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len2913738296, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (dashes, sz): (Vec<Card8>, usize) = vector_from_bytes(bytes, len2913738296 as usize)?;
        index += sz;
        Some((
            Self {
                gc,
...
impl AsByteSequence for SetClipRectanglesRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetClipRectanglesRequest from bytes");
...
impl AsByteSequence for FreeGCRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing FreeGCRequest from bytes");
        index += 1;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { gc }, index))
...
impl AsByteSequence for ClearAreaRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ClearAreaRequest from bytes");
        let (exposures, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (x, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for CopyAreaRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CopyAreaRequest from bytes");
        index += 1;
...
impl AsByteSequence for CopyPlaneRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CopyPlaneRequest from bytes");
        index += 1;
        let (src_drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (dst_drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PolyPointRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyPointRequest from bytes");
...
impl AsByteSequence for PolyLineRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyLineRequest from bytes");
        let (coordinate_mode, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for Segment {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Segment from bytes");
...
impl AsByteSequence for PolySegmentRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolySegmentRequest from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PolyRectangleRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyRectangleRequest from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PolyArcRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyArcRequest from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for FillPolyRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing FillPolyRequest from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PolyFillRectangleRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyFillRectangleRequest from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PolyFillArcRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyFillArcRequest from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PutImageRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PutImageRequest from bytes");
        let (format, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetImageRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetImageRequest from bytes");
        let (format, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetImageReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetImageReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        let (data, sz): (Vec<Byte>, usize) =
            vector_from_bytes(bytes, (length as usize * 4) as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for PolyText8Request {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyText8Request from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PolyText16Request {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PolyText16Request from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for ImageText8Request {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ImageText8Request from bytes");
        let (len3042188678, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
        ...
        let (y, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (string, sz): (String, usize) = string_from_bytes(bytes, len3042188678 as usize)?;
        index += sz;
        Some((
            Self {
                drawable,
...
impl AsByteSequence for ImageText16Request {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ImageText16Request from bytes");
        let (len964151607, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (gc, sz): (Gcontext, usize) = <Gcontext>::from_bytes(&bytes[index..])?;
        ...
        let (y, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (string, sz): (Vec<Char2b>, usize) = vector_from_bytes(bytes, len964151607 as usize)?;
        index += sz;
        Some((
            Self {
                drawable,
...
impl AsByteSequence for CreateColormapRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CreateColormapRequest from bytes");
...
impl AsByteSequence for FreeColormapRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing FreeColormapRequest from bytes");
        index += 1;
...
impl AsByteSequence for CopyColormapAndFreeRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CopyColormapAndFreeRequest from bytes");
        index += 1;
        let (mid, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for InstallColormapRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing InstallColormapRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { cmap }, index))
...
impl AsByteSequence for UninstallColormapRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UninstallColormapRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { cmap }, index))
...
impl AsByteSequence for ListInstalledColormapsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListInstalledColormapsRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { window }, index))
...
impl AsByteSequence for ListInstalledColormapsReply {
    #[inline]
    fn size() -> usize {
        <Colormap>::size() * 32 + 22 + 4 + 1 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListInstalledColormapsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len362453009, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 22;
        let (cmaps, sz): (Vec<Colormap>, usize) = vector_from_bytes(bytes, len362453009 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for AllocColorRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocColorRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for AllocColorReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocColorReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for AllocNamedColorRequest {
    #[inline]
    fn size() -> usize {
        <u8>::size() * 32 + 2 + 4 + <Colormap>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocNamedColorRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len3107486096, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len3107486096 as usize)?;
        index += sz;
...
impl AsByteSequence for AllocNamedColorReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocNamedColorReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for AllocColorCellsRequest {
    #[inline]
    fn size() -> usize {
        <Card16>::size() + <Card16>::size() + <Colormap>::size() + <cty::c_char>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocColorCellsRequest from bytes");
        let (contiguous, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for AllocColorCellsReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocColorCellsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len4043529447, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len2940930786, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 20;
        let (pixels, sz): (Vec<Card32>, usize) = vector_from_bytes(bytes, len4043529447 as usize)?;
        index += sz;
        let (masks, sz): (Vec<Card32>, usize) = vector_from_bytes(bytes, len2940930786 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for AllocColorPlanesRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocColorPlanesRequest from bytes");
        let (contiguous, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for AllocColorPlanesReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing AllocColorPlanesReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len3546092775, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (red_mask, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        ...
        index += sz;
        index += 8;
        let (pixels, sz): (Vec<Card32>, usize) = vector_from_bytes(bytes, len3546092775 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for FreeColorsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing FreeColorsRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        let (plane_mask, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for Coloritem {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Coloritem from bytes");
        let (pixel, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (red, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for StoreColorsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing StoreColorsRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { cmap }, index))
...
impl AsByteSequence for StoreNamedColorRequest {
    #[inline]
    fn size() -> usize {
        <u8>::size() * 32 + 2 + 4 + <Card32>::size() + <Colormap>::size() + <Card8>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing StoreNamedColorRequest from bytes");
        ...
        let (pixel, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len321580194, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len321580194 as usize)?;
        index += sz;
        Some((
            Self {
                flags,
...
impl AsByteSequence for Rgb {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Rgb from bytes");
        let (red, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (green, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for QueryColorsRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryColorsRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { cmap }, index))
...
impl AsByteSequence for QueryColorsReply {
    #[inline]
    fn size() -> usize {
        <Rgb>::size() * 32 + 22 + 4 + 1 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryColorsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len4092442718, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 22;
        let (colors, sz): (Vec<Rgb>, usize) = vector_from_bytes(bytes, len4092442718 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for LookupColorRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing LookupColorRequest from bytes");
        index += 1;
        let (cmap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len4045558135, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len4045558135 as usize)?;
        index += sz;
        Some((Self { cmap, name }, index))
    }
    #[inline]
...
impl AsByteSequence for LookupColorReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing LookupColorReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for CreateCursorRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CreateCursorRequest from bytes");
        index += 1;
...
impl AsByteSequence for CreateGlyphCursorRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CreateGlyphCursorRequest from bytes");
        index += 1;
        let (cid, sz): (Cursor, usize) = <Cursor>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for FreeCursorRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing FreeCursorRequest from bytes");
        index += 1;
        let (cursor, sz): (Cursor, usize) = <Cursor>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for RecolorCursorRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing RecolorCursorRequest from bytes");
        index += 1;
        let (cursor, sz): (Cursor, usize) = <Cursor>::from_bytes(&bytes[index..])?;
        index += sz;
        let (fore_red, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for QueryBestSizeRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryBestSizeRequest from bytes");
        let (class, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for QueryBestSizeReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryBestSizeReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for QueryExtensionRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryExtensionRequest from bytes");
        index += 1;
        let (len2969662638, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
        let (name, sz): (String, usize) = string_from_bytes(bytes, len2969662638 as usize)?;
        index += sz;
...
impl AsByteSequence for QueryExtensionReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing QueryExtensionReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (present, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for ListExtensionsReply {
    #[inline]
    fn size() -> usize {
        <String>::size() * 32 + 24 + 4 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListExtensionsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len1258249606, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 24;
        let (names, sz): (Vec<String>, usize) = vector_from_bytes(bytes, len1258249606 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for ChangeKeyboardMappingRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangeKeyboardMappingRequest from bytes");
...
impl AsByteSequence for GetKeyboardMappingRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetKeyboardMappingRequest from bytes");
        index += 1;
        let (first_keycode, sz): (Keycode, usize) = <Keycode>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetKeyboardMappingReply {
    #[inline]
    fn size() -> usize {
        <Keysym>::size() * 32 + 24 + <Byte>::size() + 4 + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
        index += self.sequence.as_bytes(&mut bytes[index..]);
        index += (self.keysyms.len() as Card32).as_bytes(&mut bytes[index..]);
        index += self.keysyms_per_keycode.as_bytes(&mut bytes[index..]);
        index += 24;
        index += vector_as_bytes(&self.keysyms, &mut bytes[index..]);
        index
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetKeyboardMappingReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len2239609683, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (keysyms_per_keycode, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 24;
        let (keysyms, sz): (Vec<Keysym>, usize) = vector_from_bytes(bytes, len2239609683 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for ChangeKeyboardControlRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangeKeyboardControlRequest from bytes");
        index += 1;
        let (value_mask, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (value_list, sz): (Vec<u32>, usize) =
...
impl AsByteSequence for GetKeyboardControlReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetKeyboardControlReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for BellRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing BellRequest from bytes");
...
pub struct ChangePointerControlRequest {
    ...
    pub threshold: Int16,
    pub do_acceleration: cty::c_char,
    pub do_threshold: cty::c_char,
}
impl AsByteSequence for ChangePointerControlRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangePointerControlRequest from bytes");
        index += 1;
        ...
        index += sz;
        let (do_acceleration, sz): (cty::c_char, usize) =
            <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (do_threshold, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((
            Self {
...
impl AsByteSequence for GetPointerControlReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetPointerControlReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for SetScreenSaverRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetScreenSaverRequest from bytes");
        index += 1;
...
impl AsByteSequence for GetScreenSaverReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetScreenSaverReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for ChangeHostsRequest {
    #[inline]
    fn size() -> usize {
        <Byte>::size() * 32 + 4 + 1 + <Card8>::size() + <Card8>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ChangeHostsRequest from bytes");
        let (mode, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (family, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len1153836342, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (address, sz): (Vec<Byte>, usize) = vector_from_bytes(bytes, len1153836342 as usize)?;
        index += sz;
        Some((
            Self {
                mode,
...
impl AsByteSequence for Host {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing Host from bytes");
        let (family, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 1;
        let (len2526536798, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (address, sz): (Vec<Byte>, usize) = vector_from_bytes(bytes, len2526536798 as usize)?;
        index += sz;
...
impl AsByteSequence for ListHostsReply {
    #[inline]
    fn size() -> usize {
        <Host>::size() * 32 + 22 + 4 + <Byte>::size() + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ListHostsReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (mode, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len614653253, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 22;
        let (hosts, sz): (Vec<Host>, usize) = vector_from_bytes(bytes, len614653253 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for SetAccessControlRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetAccessControlRequest from bytes");
        let (mode, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for SetCloseDownModeRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetCloseDownModeRequest from bytes");
        let (mode, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { mode }, index))
    }
...
impl AsByteSequence for KillClientRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing KillClientRequest from bytes");
        index += 1;
...
impl AsByteSequence for RotatePropertiesRequest {
    #[inline]
    fn size() -> usize {
        <Atom>::size() * 32 + <Int16>::size() + 4 + <Window>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing RotatePropertiesRequest from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len3801758675, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (delta, sz): (Int16, usize) = <Int16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (atoms, sz): (Vec<Atom>, usize) = vector_from_bytes(bytes, len3801758675 as usize)?;
        index += sz;
        Some((
            Self {
                window,
...
impl AsByteSequence for ForceScreenSaverRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ForceScreenSaverRequest from bytes");
        let (mode, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        Some((Self { mode }, index))
    }
...
impl AsByteSequence for SetPointerMappingRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetPointerMappingRequest from bytes");
        let (len1488043814, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (map, sz): (Vec<Card8>, usize) = vector_from_bytes(bytes, len1488043814 as usize)?;
        index += sz;
        Some((Self { map }, index))
    }
    #[inline]
...
impl AsByteSequence for SetPointerMappingReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetPointerMappingReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetPointerMappingReply {
    #[inline]
    fn size() -> usize {
        <Card8>::size() * 32 + 24 + 4 + <Card32>::size() + <Card16>::size()
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetPointerMappingReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
        let (len957337579, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 24;
        let (map, sz): (Vec<Card8>, usize) = vector_from_bytes(bytes, len957337579 as usize)?;
        index += sz;
        Some((
            Self {
                sequence,
...
impl AsByteSequence for SetModifierMappingRequest {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetModifierMappingRequest from bytes");
        let (keycodes_per_modifier, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (keycodes, sz): (Vec<Keycode>, usize) =
            vector_from_bytes(bytes, (keycodes_per_modifier as usize * 8) as usize)?;
        index += sz;
        Some((
            Self {
...
impl AsByteSequence for SetModifierMappingReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SetModifierMappingReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for GetModifierMappingReply {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GetModifierMappingReply from bytes");
        let (sequence, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
        index += sz;
        let (length, sz): (Card32, usize) = <Card32>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for KeymapNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing KeymapNotifyEvent from bytes");
...
impl AsByteSequence for NoExposureEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing NoExposureEvent from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for FocusOut {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing FocusInEvent from bytes");
...
impl AsByteSequence for ConfigureNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ConfigureNotifyEvent from bytes");
        index += 1;
        let (event, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for CreateNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CreateNotifyEvent from bytes");
        index += 1;
        let (parent, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
pub struct UnmapNotifyEvent {
    pub event: Window,
    pub window: Window,
    pub from_configure: cty::c_char,
}
impl AsByteSequence for UnmapNotifyEvent {
    #[inline]
    fn size() -> usize {
        3 + <cty::c_char>::size() + <Window>::size() + <Window>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing UnmapNotifyEvent from bytes");
        index += 1;
        let (event, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (from_configure, sz): (cty::c_char, usize) =
            <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 3;
        Some((
...
impl AsByteSequence for SelectionRequestEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SelectionRequestEvent from bytes");
        index += 1;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
        let (owner, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for SelectionNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SelectionNotifyEvent from bytes");
        index += 1;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
        let (requestor, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for GraphicsExposureEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GraphicsExposureEvent from bytes");
        index += 1;
        let (drawable, sz): (Drawable, usize) = <Drawable>::from_bytes(&bytes[index..])?;
        index += sz;
        let (x, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for DestroyNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing DestroyNotifyEvent from bytes");
        index += 1;
        let (event, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for SelectionClearEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing SelectionClearEvent from bytes");
        index += 1;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
        let (owner, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for GravityNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing GravityNotifyEvent from bytes");
        index += 1;
        let (event, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for ButtonRelease {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ButtonPressEvent from bytes");
...
impl AsByteSequence for ConfigureRequestEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ConfigureRequestEvent from bytes");
...
impl AsByteSequence for MappingNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing MappingNotifyEvent from bytes");
        index += 1;
...
impl AsByteSequence for LeaveNotify {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing EnterNotifyEvent from bytes");
        let (detail, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for KeyRelease {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing KeyPressEvent from bytes");
...
impl AsByteSequence for MotionNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing MotionNotifyEvent from bytes");
        let (detail, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        let (time, sz): (Timestamp, usize) = <Timestamp>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for ClientMessageEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ClientMessageEvent from bytes");
        let (format, sz): (Card8, usize) = <Card8>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
...
impl AsByteSequence for MapNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing MapNotifyEvent from bytes");
        index += 1;
        let (event, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for ExposeEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ExposeEvent from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (x, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for ResizeRequestEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ResizeRequestEvent from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (width, sz): (Card16, usize) = <Card16>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for CirculateNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing CirculateNotifyEvent from bytes");
        index += 1;
        let (event, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for PropertyNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing PropertyNotifyEvent from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (atom, sz): (Atom, usize) = <Atom>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for ColormapNotifyEvent {
    #[inline]
    fn size() -> usize {
        2 + <Byte>::size() + <cty::c_char>::size() + <Colormap>::size() + <Window>::size() + 1
    }
    #[inline]
    fn as_bytes(&self, bytes: &mut [u8]) -> usize {
        let mut index = 0;
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ColormapNotifyEvent from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (colormap, sz): (Colormap, usize) = <Colormap>::from_bytes(&bytes[index..])?;
        index += sz;
        let (new, sz): (cty::c_char, usize) = <cty::c_char>::from_bytes(&bytes[index..])?;
        index += sz;
        let (state, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
        index += sz;
        index += 2;
...
impl AsByteSequence for MapRequestEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing MapRequestEvent from bytes");
        index += 1;
        let (parent, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for ReparentNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing ReparentNotifyEvent from bytes");
        index += 1;
        let (event, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
...
impl AsByteSequence for VisibilityNotifyEvent {
    ...
    fn from_bytes(bytes: &[u8]) -> Option<(Self, usize)> {
        let mut index = 0;
        log::trace!("Deserializing VisibilityNotifyEvent from bytes");
        index += 1;
        let (window, sz): (Window, usize) = <Window>::from_bytes(&bytes[index..])?;
        index += sz;
        let (state, sz): (Byte, usize) = <Byte>::from_bytes(&bytes[index..])?;
