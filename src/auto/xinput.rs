...
impl AsByteSequence for GetExtensionVersionRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + ::core::mem::size_of::<Card16>() + self.length.size() + 2 + {
...
impl AsByteSequence for OpenDeviceRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.device_id.size() + self.length.size() + 3
    }
}
...
impl AsByteSequence for SetDeviceModeRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.device_id.size() + self.length.size() + self.mode.size() + 2
    }
}
...
impl AsByteSequence for UngrabDeviceRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.time.size() + self.length.size() + self.device_id.size() + 3
    }
}
...
impl AsByteSequence for DeleteDevicePropertyRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.property.size() + self.length.size() + self.device_id.size() + 3
    }
}
...
impl AsByteSequence for XiQueryPointerRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.window.size() + self.length.size() + self.deviceid.size() + 2
    }
}
...
impl AsByteSequence for XiChangeHierarchyRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + ::core::mem::size_of::<Card8>() + self.length.size() + 3 + {
...
impl AsByteSequence for XiQueryDeviceRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.deviceid.size() + self.length.size() + 2
    }
}
...
impl AsByteSequence for XiUngrabDeviceRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.time.size() + self.length.size() + self.deviceid.size() + 2
    }
}
...
impl AsByteSequence for XiDeletePropertyRequest {
    ...
    #[inline]
    fn size(&self) -> usize {
        self.req_type.size() + self.deviceid.size() + self.length.size() + 2 + self.property.size()
    }
}
